...
public class VehiclePartsEntity {
    ...
    public VehiclePartsEntity() {
    }

    private String colour;
    private String description;

    public VehiclePartsEntity(String partsId, int qty, String code, String colour, String description, String nameOfVehiclePart, double price) {
