...
public class VehicleOrderEntity {
    ...
    public VehicleOrderEntity(String vehicleOrderId, String customernName, String customerId, String orderDate, String orderTime, double cost, ArrayList<VehicleOrderDetails> details) {
        VehicleOrderId = vehicleOrderId;
        this.customernName = customernName;
        this.customerId = customerId;
        this.orderDate = orderDate;
