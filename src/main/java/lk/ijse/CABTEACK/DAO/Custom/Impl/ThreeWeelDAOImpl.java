...
public class ThreeWeelDAOImpl implements ThreeWeelDao {
    @Override
    public ArrayList<VehicleEntity> getAll() throws SQLException, ClassNotFoundException {
        ArrayList<VehicleEntity> cars = new ArrayList<>();

        ResultSet res = SqlUtil.execute("SELECT * FROM vehicle WHERE vehicleType = 'Three Wheel'");
        {
