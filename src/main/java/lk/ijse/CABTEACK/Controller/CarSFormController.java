...
public class CarSFormController {
    ...
    public JFXButton btnFreewheel;
    public AnchorPane ANCHOR;
    @FXML
    private JFXButton AddVehicleBttn;
    ...
    @FXML
    private JFXTextField SearchIdtxt;
    ...
    @FXML
    private TableColumn<VehicleTm,Integer> colQty;
    ...
    @FXML
    private JFXButton updateVehiclebtn;
    ...
    public void initialize() throws SQLException, ClassNotFoundException {
        ...
        colAction.setCellFactory(param -> new CarSFormController.ActionButtonTableCell());
    ...
    private void loadVehicId() throws SQLException, ClassNotFoundException {
        List<String> vehiId = carsBo.getVehicleIds();
        TextFields.bindAutoCompletion(SearchIdtxt,vehiId);
    }
    ...
    private void loadAllVehicle() throws SQLException, ClassNotFoundException {
        ...
        ArrayList<vehicle> allCars = carsBo.getAllVehicle();
        for (vehicle dto:allCars) {
    ...
    @FXML
    void AddVehicleBttnOnActon(ActionEvent event) throws SQLException, ClassNotFoundException {
        try {
...
/*        boolean isSaved = customerBO.saveCustomer(new CustomerDTO(id, name, address));
    ...
    private void searchTble() throws SQLException, ClassNotFoundException {
        String searchText = SearchIdtxt.getText().trim();
        String sql;
    ...
    @FXML
    void updateVehiclebtnOnAction(ActionEvent event) throws SQLException, ClassNotFoundException {
    ...
    public void btnTreewheelOnAction(ActionEvent actionEvent) throws IOException {
