...
public class vehiclePartsOrder {
    ...
    public vehiclePartsOrder(String partOrderId, String customerId, String orderDate, String orderTime, double cost, ArrayList<vehiclePartOrderDetail> details) {
        this.partOrderId = partOrderId;
        this.customerId = customerId;
        this.orderDate = orderDate;
        this.orderTime = orderTime;
